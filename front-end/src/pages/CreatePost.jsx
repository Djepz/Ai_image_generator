    ...
    <section className='max-w-7xl mx-auto'>
      <div>
        ...
        <p className='mt-2 text-[#666e75] text-[16px] max-w[500px]'>
          Create imaginative and visually stunning images generated through DALL-E AI and share them
        </p>
      </div>
      <form className='mt-16 max-w-3xl' onSubmit={handleSubmit}>
            ...
            focus:ring-blue-500 focus:border-blue-500 w-64 p-3 h-64 flex justify-center items-center'>
              {form.photo ? (
                ...
                <img 
                  src={preview}
                  alt="preview"
                  className='w-9/1 h-9/12 object-contain opacity-400'
                />
              )}
        ...
        <div className='mt-5 flex gap-5'>
          <button
            ...
            >{generateImg ? 'Generating..' : 'Generate'}</button>
        </div>

        <div className='mt-10'>
          <p className='mt-2 text-[#666e75] text-[14px]'>Once you have created the image you want, you can share it if you want</p>
